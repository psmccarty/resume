...
\begin{document}
    ...
    \section{Experience}
        ...
        \begin{onecolentry}
            \begin{highlights}
                ...
                \item Created a feature for A/B testing in app offers. Allows product owners to slowly rollout offers and evaluate performance before enabling them for all users. 
    ...
    \section{Skills}
        ...
        \begin{onecolentry}
            \textbf{Technologies:} Git, Bash, AWS, Docker, RESTful APIs, DynamoDB, SQLite3
        \end{onecolentry}

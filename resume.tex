...
\begin{document}
    ...
    \section{Education}
        ...
        \begin{onecolentry}
            \begin{highlights}
                \item \textbf{GPA:} 4.0 (\href{https://example.com}{a link to somewhere})
        ...
        \begin{onecolentry}
            \begin{highlights}
                \item \textbf{GPA:} 3.8 (\href{https://example.com}{a link to somewhere})
            \end{highlights}
        \end{onecolentry}
    ...
    \section{Publications}
        ...
        \begin{samepage}
            ...
            \begin{onecolentry}
                \mbox{Frodo Baggins}, \mbox{\textbf{\textit{Patrick McCarty}}}, \mbox{Samwise Gamgee}
